                            ...
                            <div class="row align-items-center no-gutters">
                                ...
                                <div class="col-lg-2 col-md-12">
                                    <div class="d-single-info text-lg-center">
                                        <a href="{{ route('cart') }}" class="view-cart"><i class="fa fa-cart-plus"></i>view cart</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 col-lg-2">
                                ...
                                <ul role="tablist" class="nav flex-column dashboard-list">
                                    ...
                                    <li><a href="{{ route('login')}}" class="nav-link">logout</a></li>
                                </ul>
                            </div>
                                                ...
                                                <div class="account-login-form">
                                                    <form action="#">
                                                        ...
                                                        <div class="custom-checkbox">
                                                            ...
                                                            <label>Sign up for our newsletter<br><em>You may unsubscribe at
                                                                    any moment. For that purpose, please find our contact
                                                                    info in the legal notice.</em></label>
                                                        </div>
