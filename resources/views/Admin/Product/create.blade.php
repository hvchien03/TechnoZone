            ...
            <div class="flex">
                  ...
                  hover:file:bg-violet-100"
                    ...
                    <div class="flex h-20">
                        <div class="w-1/2 pr-2">
                            ...
                            <div class="mt-2">
                                <select class="w-full rounded-sm h-8" name="supplierId">
                        ...
                        <div class="w-1/2 pl-2">
                            <div class="h-20">
                                ...
                                <div class="mt-2">
                                    <select class="w-full rounded-sm h-8" name="categoryId">
                ...
                <div class="w-1/2 p-3">
                    <div class="h-40">
                        ...
                        <div class="mt-2">
                            <textarea class="w-full rounded-sm p-2" rows="4" style="overflow:hidden" placeholder="" name="configuration">{{old('configuration')}}</textarea>
                        </div>
                    </div>
                    <div class="h-40">
                        ...
                        <div class="mt-2">
                            <textarea class="w-full rounded-sm p-2" rows="4" style="overflow:hidden" placeholder="" name="warrantyPolicy">{{old('warrantyPolicy')}}</textarea>
                        </div>
                    </div>
                </div>
            </div>
