...
<div class="flex flex-col gap-5 min-h-[calc(100vh-188px)] sm:min-h-[calc(100vh-204px)]">
    ...
    <div class="grid grid-cols-1 xl:grid-cols-2 gap-5">
        ...
        <div class="bg-white dark:bg-dark dark:border-gray/20 border-2 border-lightgray/10 p-5 rounded-lg">
            ...
            <div class="space-y-5">
                <img src="{{ asset('assets/admin/assets/images/map-light.png')}}" class="dark:hidden mx-auto" alt="">
                <img src="{{ asset('assets/admin/assets/images/map-dark.png')}}" class="dark:block hidden mx-auto" alt="">
                ...
                <table class="min-w-[640px] w-full product-table">
                    ...
                    <tbody>
                        <tr class="text-left">
                            ...
                            <td>
                                <div class="flex items-center gap-2.5">
                                    <img src="{{ asset('assets/admin/assets/images/assets/1.png')}}" class="w-[50px] rounded-full" alt="">
                        ...
                        <tr class="text-left">
                            ...
                            <td>
                                <div class="flex items-center gap-2.5">
                                    <img src="{{ asset('assets/admin/assets/images/assets/2.png')}}" class="w-[50px] rounded-full" alt="">
                        ...
                        <tr class="text-left">
                            ...
                            <td>
                                <div class="flex items-center gap-2.5">
                                    <img src="{{ asset('assets/admin/assets/images/assets/3.png')}}" class="w-[50px] rounded-full" alt="">
                        ...
                        <tr class="text-left">
                            ...
                            <td>
                                <div class="flex items-center gap-2.5">
                                    <img src="{{ asset('assets/admin/assets/images/assets/4.png')}}" class="w-[50px] rounded-full" alt="">
