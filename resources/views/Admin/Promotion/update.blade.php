                    ...
                    <form action="{{ route('promotions.update', $promotion->id) }}" method="POST"
                        ...
                        <div class="flex items-center justify-between flex-wrap gap-5">
                            <div class="p-5 bg-gray/10 rounded-lg">
                                <p class="font-semibold leading-none">Chương trình khuyến mãi #{{ $promotion->id }}</p>
                            </div>
                        ...
                        <div class="flex sm:flex-row flex-col sm:items-center gap-5 flex-wrap">
                            <div class="space-y-4 flex-1">
                                <label for="promotionName" class="text-sm">Chương trình khuyến mãi
                    ...
                    <form action="{{ route('promotions.update', $promotion->id) }}" method="POST"
                        ...
                        <div class="space-y-4">
                            <div
                                ...
                                <h2 class="text-base font-semibold mb-4">Sản phẩm áp dụng khuyến mãi
