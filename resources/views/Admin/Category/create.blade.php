...
@section('content')
    <div class="w-full bg-gray-200 rounded-sm">
        <p class="text-center mt-10 text-3xl py-8">Thêm loại sản phẩm mới</p>
            ...
            <div class="flex">
                <div class="w-full p-3 border-2 border-lightgray/10 p-5 rounded-lg">
                    <div class="h-20 bg-white dark:bg-dark dark:border-gray/20 ">
                        <label for="name" class="text-base font-semibold mb-4">Tên loại sản phẩm
                    ...
                    <div class="h-20 bg-white dark:bg-dark dark:border-gray/20 ">
                        <label for="description" class="text-base font-semibold mb-4">Mô tả
