                            ...
                            <div class="sidbar-product-inner">
                                <div class="product-image">
                                    <a href="product-details.html"><img
                                            src="{{ asset('assets/client/images/product/10.jpg') }}" alt=""></a>
                                </div>
                ...
                <div class="col-lg-9 order-lg-2 order-1">
                    ...
                    <div class="blog-details-wrapper">
                        <div class="blog-details-image">
                            <img src="{{ asset('assets/client/images/blog/blog-bg-1.jpg') }}" alt="">
                        </div>
                        <div class="postinfo-wrapper">
                            <div class="post-info">
                                <p>Donec vitae hendrerit arcu, sit amet faucibus nisl. Cras pretium arcu ex. Aenean posuere
                                    ...
                                    Pellentesque faucibus sem ante, non malesuada odio varius nec. Suspendisse potenti. </p>
                                <blockquote class="blockquote-inner">
                                    <p>Quisque semper nunc vitae erat pellentesque, ac placerat arcu consectetur. In
                                        venenatis elit ac ultrices convallis. Duis est nisi, tincidunt ac urna sed, cursus
                                        blandit lectus. In ullamcorper sit amet ligula ut eleifend. Proin dictum tempor
